...
public class StreamMapperShould
{
    ...
    {
        new(
            new(DateTime.Parse("01.10.2023 12:03"), -5.9m, "$", String.Empty, "Some withdraw",
                new("Test Account", "Test Bank")),
            new(null, null, "MCC 9000")
        ),
        new(
            new(DateTime.Parse("01.10.2023 12:04"), -4.9m, "$", String.Empty, "Some withdraw",
                new("Test Account", "Test Bank")),
            new(null, null, "MCC 9000")
        ),
        new(
            new(DateTime.Parse("01.10.2023 12:05"), -3.9m, "$", String.Empty, "Some withdraw",
                new("Test Account", "Test Bank")),
            new(null, null, "MCC 9000")
        ),
    };
